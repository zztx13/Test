...
$(function () {
    ...
    console.log($("html").width()*0.9226);
	$(".banner_r .banner_i").width($("html").width()*0.8906);
	$(".banner_r").width($("html").width()*0.9226*$(".banner_r .banner_i").length);
	...
	$(".control a").bind("click", function () {
		...
		$(".banner_r").stop(true, true).animate({ marginLeft: -($("html").width()*0.916*(adboti-1)) + "px" }, 1000);
